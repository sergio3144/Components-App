      ...
      <ThemedCard>
        <SectionList
          ...
          renderSectionHeader={({ section }) => (
            <ThemedText
              type="h1"
              className="bg-light-background dark:bg-dark-background p-2 rounded mb-5 "
            >
              {section.title}
            </ThemedText>
          )}
          ...
          ListFooterComponent={() => (
            <ThemedText type="h1" className="font-bold  bg-light-background dark:bg-dark-background p-2 mb-10 rounde">
